      ...
      <?php foreach ($booths as $booth) : ?>
        <div class="row row-sliding no-gutters pl-3">
          ...
          <div class="col-4 col-md-2 slide-tray" id="tools-<?php echo $booth->BoothId; ?>">
            <a href="/hsef/?page=boothForm&bid=<?php echo $booth->BoothId ?>&readonly=false" class="col-4 tool-icon bg-green">
              <i class="fas fa-edit text-white"></i>
            </a>
            <a href="/hsef/?page=boothForm&bid=<?php echo $booth->BoothId ?>&readonly=true" class="col-4 tool-icon bg-primary">
                ...
                <form method="POST">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      ...
                      <input type="text" name="deleteConfirm" id="boothNameConfirmation-<?php echo $booth->BoothId ?>" disabled>
