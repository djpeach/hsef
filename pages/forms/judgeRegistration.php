<main>
  <article class="limit-width-md pt-5">
    ...
    ?>
    <?php if ($registered) : ?>
      <h2 class="article-header">Registered!</h2>
      <?php include 'components/divider.php' ?>
      <div class="alert alert-darkgreen mt-5" role="alert">
        <h2 class="alert-heading">Thank you!</h2>
        <hr>
        <p>You have been submitted for approval to judge <?php date('Y') ?> Hoosier Science and Engineering Fair. Read more about us
          <a href="http://sefi.org/hsef/" class="alert-link">here</a></p>
        <hr>
        <p class="mb-0">Be on a lookout for an acceptance email from <?php echo $rootEmail; ?> with the subject "Approved to Judge HSEF".</p>
      </div>
    <?php else : ?>
      <h2 class="article-header">Judge Registration</h2>
      <?php include 'components/divider.php' ?>
      <form method="POST" class="container">
        <?php include_once 'components/formFields/userFields.php' ?>
        <fieldset>
          <div class="row mt-3">
            <div class="col">
