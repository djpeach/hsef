...
<main>
  <article class="limit-width-md p-5">
    ...
    <h2 class="article-header"> Judging Session </h2>
    ...
    <form method="POST" class="container">
      ...
      <div class="row mt-3">
        <div class="col">
          <div class="floating-label-group">
            <input type="text" placeholder="Start Time*" id="number" name="number">
        ...
        <div class="col">
          <div class="floating-label-group">
            <input type="text" placeholder="End Time*" id="number" name="number" >
