...
INSERT INTO User(UserId, FirstName, LastName, Gender, Status, Email, CreateBy, UpdateBy)
VALUES (2, 'Ashley', 'Harris', 'female', 'active', 'harris16@iu.edu', 1, 1); # 2
INSERT INTO User(UserId, FirstName, LastName, Gender, Status, Email, CreateBy, UpdateBy)
VALUES (3, 'Daniel', 'Northam', 'male', 'active', 'dnortham@iu.edu', 1, 1); # 3
INSERT INTO User(UserId, FirstName, LastName, Gender, Status, Email, CreateBy, UpdateBy)
VALUES (4, 'Kate', 'Davis', 'female', 'active', 'kadadavi@iu.edu', 1, 1); # 4
INSERT INTO User(UserId, FirstName, LastName, Gender, Status, Email, CreateBy, UpdateBy)
VALUES (5, 'Andy', 'Harris', 'male', 'active', 'ajharris@iupui.edu', 1, 1); # 5
INSERT INTO User(UserId, FirstName, LastName, Gender, Status, Email, CreateBy, UpdateBy)
VALUES (6, 'Lingma', 'Acheson', 'female', 'active', 'linglu@iupui.edu', 1, 1); # 6
...
INSERT INTO AuthAccount(AuthAccountId, Username, PasswordHash, CreateBy, UpdateBy)
VALUES (2, 'harris16', '$2y$10$oDxFkCtEjgAmJb7VQrpJTeq6DU5ICU1O3xBl1uWyteAh2ngusNns6', 1, 1);
INSERT INTO AuthAccount(AuthAccountId, Username, PasswordHash, CreateBy, UpdateBy)
VALUES (3, 'dnortham', '$2y$10$QEGvUI8tmr8JiBvqd6BRfel4QlSGJNadsEmtVnm5rfILLIEg0CMUi', 1, 1);
INSERT INTO AuthAccount(AuthAccountId, Username, PasswordHash, CreateBy, UpdateBy)
VALUES (4, 'kadadavi', '$2y$10$PP7DCm/dqE7fPjRYyPyjDeMzuBB7hG6LDdw8v0d5ypbIyfDRXv/HC', 1, 1);
INSERT INTO AuthAccount(AuthAccountId, Username, PasswordHash, CreateBy, UpdateBy)
VALUES (5, 'ajharris', '$2y$10$qPYniUF.xnAqQLS0c9hRLeyrCURFfQ/fBS2foss9BBB88sxFNQVRC', 1, 1);
INSERT INTO AuthAccount(AuthAccountId, Username, PasswordHash, CreateBy, UpdateBy)
VALUES (6, 'linglu', '$2y$10$FvhE/RIh5WAvzsydAj0mte8U6e3dDogK6SP.dY/PuvuG6E9k3KvWS', 1, 1);
...
INSERT INTO Operator(OperatorId, UserId, CreateBy, UpdateBy)
VALUES (1, 1, 1, 1);
INSERT INTO Operator(OperatorId, UserId, CreateBy, UpdateBy)
VALUES (2, 2, 1, 1);
INSERT INTO Operator(OperatorId, UserId, CreateBy, UpdateBy)
